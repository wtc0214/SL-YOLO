...
class C3k2_DRB(C2f):
    ...
    def __init__(self, c1, c2, n=1, k=7, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else UniRepLKNetBlock(self.c, k) for _ in range(n)
        )


class C3k2_DRB_v2(nn.Module):
    """Faster Implementation of CSP Bottleneck with 2 convolutions and optional C3k or UniRepLKNetBlock."""

    def __init__(self, c1, c2, n=1, k=7, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__()
        self.c = int(c2 * e)  # 缩减后的通道数
